/*
* Eugene Furman 2/5/2016
* 
* This is a simple development application and not required a deep project structure.
* Also, because of the application size (just one javascript file) I didn't use jQuery. I didn't want to load extra library.
* Some of the images were missed, so I use similar images to replace them.
* Project was done in Aptana Studio and it may include additional files.
* 
*/
